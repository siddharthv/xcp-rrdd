...
(* OASIS_START *)
(* DO NOT EDIT (digest: 53cc651d6995756f376fea2c230d7245) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "rrdd-libs";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("rpclib.unix", None);
                           FindlibPackage ("gzip", None);
                           FindlibPackage ("forkexec", None);
                           FindlibPackage ("stdext", None);
                           ...
                           FindlibPackage ("oclock", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["blktap3_stats_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "xcp_rrdd.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "ks\189Gdhoa\199\1561\164\011\255\207\221";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
